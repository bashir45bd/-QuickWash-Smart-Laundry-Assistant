...
public class WashIron extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wash_list = view.findViewById(R.id.wash_iron_list);
        ...
        Log.d("Adapter", "Checkbox changed: " + service_id);
    ...
    private class Adapter extends RecyclerView.Adapter<WashIron.Adapter.viewholder> {
...
//        };
        ...
        @NonNull
        @Override
        public WashIron.Adapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_items, parent, false);
            return new WashIron.Adapter.viewholder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull WashIron.Adapter.viewholder holder, int position) {
